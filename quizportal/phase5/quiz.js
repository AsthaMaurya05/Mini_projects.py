const questions=[
    ...
    // ✅ Q6 (CHANGED)
    {
        ...
        options:[
            "A. Integers have a fixed maximum size",
            "B. Integers are immutable objects",
            "C. Integers are stored as strings",
            "D. Integers must be declared with int"
        ],
        correctindex:1
    },
    ...
    // ✅ Q12 (CHANGED)
    {
        question:"Which statement correctly describes Boolean values in Python?",
        options:[
            "A. Boolean values are strings",
            "B. Boolean values are separate objects but subclass of int",
            "C. Boolean values cannot be compared",
            "D. Python does not support booleans"
        ],
        correctindex:1
    },
    ...
    // ✅ Q17 (CHANGED)
    {
        ...
        options:[
            "A. Floats are always precise",
            "B. Floats are immutable",
            "C. Floats can store only integers",
    ...
    // ✅ Q26 (CHANGED)
    {
        question:"Which of the following is the correct use of triple quotes in Python?",
        options:[
    ...
    {
        question:"What will be the output?<br>x = 10<br>y = x<br>print(x is y)",
